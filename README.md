...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/restless-field-ea2a
```

A live public deployment of this template is available at [https://restless-field-ea2a.templates.workers.dev](https://restless-field-ea2a.templates.workers.dev)
